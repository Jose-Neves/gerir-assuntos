...
$dataHoje=date('Ymd').'0000';
$saidasListar = $app->saidasDetailsListar($dataHoje); // get saidas details
$dataDia='00';

//LOOP TABLE ROWS
foreach ($saidasListar as $row){
	if ($dataDia<>substr ( $row['datahora_sd'] , 6, 2 )) echo '----------------------------------------</br>';
		echo "<b>Data:</b> ";
		...
		if ($saidas > '0'){
			echo " &nbsp;  &nbsp;";
			?>
			<a href="sd-alteraSaida.php?indiceSaida=<?php echo $row['id_saida']; ?>">Alt.</a>
			<?php
		}
	echo '</br></br>';
	}
