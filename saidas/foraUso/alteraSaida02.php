...
<?php
	$indiceAlterado=$_POST['indiceAlterado'];
	...
	$Morada = $_POST['morada'];
	$Observ = $_POST['observ'];
	$MarcadoPor = $_POST['marcadaPor'];
	echo '</br>';echo '</br>';
	if ($DataHoraGravar<$DataHora){
		print "<h2>N&tilde;o se pode marcar sa&iacute;das para dias anteriores</h2>";
		...
		$queryApagaSaidas = "UPDATE `bgbztbl_saidas` SET `saidatbl_apagada` = 's' WHERE `bgbztbl_saidas`.`saidatbl_id` = ".$indiceAlterado;
		//echo $queryApagaSaidas;
		$grava = mysqli_query($conn,$queryApagaSaidas);
